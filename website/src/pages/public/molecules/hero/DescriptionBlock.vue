...
import Image from "@/pages/public/atoms/illustration/Image.vue";
</script>

<template>
    <div class="p-5 bg-(--color-night) flex flex-col justify-end items-center gap-3 rounded-xl">
        <Image :src="ComputerPng" alt="computer" class="max-w-48"/>
        <Text :size="TextSize.xl" class="text-gray-50">
