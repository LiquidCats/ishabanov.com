...
import type {Link as LinkType} from "../../../domain/types/link";
...
<template>
    <div class="bg-gradient-to-tl from-blue-600 to-purple-400 rounded-md justify-center flex items-center relative">
