...
import {TagResource} from "../../../domain/types/api";
...
<template>
    <header class="h-96 rounded-xl mb-3 overflow-hidden bg-cover bg-no-repeat bg-center" :style="`background-image: url('${imageUrl}')`">
