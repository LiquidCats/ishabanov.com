...
<template>
    <div :style="`background-image: url('${postState.item?.previewImage?.path}')`"
        ...
        <PlusIcon class="size-12" v-if="!postState.hasPreview"/>
        <div class="flex gap-1 absolute bottom-0 left-0 right-0 justify-center p-1 bg-stone-900/[.5]" v-if="postState.hasPreview">
