...
<template>
    <div class="flex rounded-md overflow-clip border border-stone-500 divide-stone-700 divide-x bg-neutral-100 hover:border-stone-400 ease-in-out transition-colors">
        <button v-for="fontFamilyStyle in fontFamilyStyles"
                :key="`font-family-${fontFamilyStyle}`"
                class="dark:bg-zinc-600 darl:hover:bg-stone-700 hover:bg-stone-200 duration-300 ease-in-out transition-colors px-4 py-1 uppercase text-sm"
                :class="{
                    'bg-stone-200 dark:bg-zinc-700': selected === fontFamilyStyle,
