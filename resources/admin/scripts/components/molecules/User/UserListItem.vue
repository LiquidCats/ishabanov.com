...
<template>
  <div class="flex flex-col rounded-md p-3 bg-neutral-50 dark:bg-zinc-700 relative"
       :class="{
        'border border-indigo-500 dark:border-indigo-300': isCurrentUser
       }"
       :key="userId">
    ...
    <div class="mb-3 pb-1 border-b border-neutral-500">
      <div class="font-bold text-xl dark:text-gray-50">{{ name }}</div>
      <small class="text-sm text-gray-400">{{ email }}</small>
    </div>
