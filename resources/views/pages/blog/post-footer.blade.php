...
<div class="row">
    <div class="col-md-6">
     @if($next)
        <a href="{{ route('pages.blog.post', ['post_id' => $next->getKey()]) }}" class="card lc-card text-decoration-none">
    ...
    <div class="col-md-6">
    @if($prev)
        <a href="{{ route('pages.blog.post', ['post_id' => $prev->getKey()]) }}" class="card lc-card text-decoration-none">
           <div class="card-body lc-card-body">
               <div class="row">
                   <div class="col-11">
