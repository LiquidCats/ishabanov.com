<section id="hero" class="container-fluid d-flex align-items-center justify-content-center lc-hero bg-dark">
    ...
    <div class="row justify-content-center min-vh-100">
        <div class="col-md-12 col-lg align-self-center text-white">
            <div class="display-1 m-0 fw-bold text-center text-lg-end text-uppercase">Software Engineer</div>
            <div class="display-1 m-0 mb-4 fw-light text-center text-lg-end text-uppercase">Solving Problems</div>
            <div class="row">
